...
cleaned_df.repartition(1).write.mode("overwrite").format("json").save("/user/cs4984cs5984f18_team4/4_Hurricane_Sandy/limin/sentences") // export data to your local path;be aware on DLRL cluster, this will be HDFS path
